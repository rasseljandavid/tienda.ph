...
<nav id="topnavbar" class="navigation navbar yamm navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <!-- menu header -->
            <a class="navbar-brand" href="{$smarty.const.URL_FULL}"><img src="{$smarty.const.THEME_RELATIVE}images/logo.png" alt="" /></a>
        </div>
        <!-- menu -->
        <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
			<div class="search-container">{showmodule controller=store action=ecomSearch}</div>
