...
__cov_PBBzFuQXOKkl1sZvW2L$7w.s['1']++;YUI.add('axis-stacked',function(Y,NAME){__cov_PBBzFuQXOKkl1sZvW2L$7w.f['1']++;__cov_PBBzFuQXOKkl1sZvW2L$7w.s['2']++;Y.StackedAxis=Y.Base.create('stackedAxis',Y.NumericAxis,[Y.StackedImpl]);},'3.18.1',{'requires':['axis-numeric','axis-stacked-base']});
