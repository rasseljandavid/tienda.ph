...
<div class="module donation showall">
    ...
    <table>
        <tr>
            ...
            <td style="padding: 5px;">
                <a class="add-to-cart-btn {button_style color=blue size=large}" href={link controller=cart action=addItem product_type=$product->product_type product_id=$product->id quick=$quickadd}>{expCore::getCurrencySymbol()}&#160;{'Donate'|gettext} {if $config.quickadd}{$product->base_price|currency}{/if}</a>
            </td>
         </tr>
    </table>
</div>
