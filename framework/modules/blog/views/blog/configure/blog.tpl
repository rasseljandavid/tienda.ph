...
{control type="radiogroup" name="usebody" label="Display Post Content in List"|gettext value=$config.usebody|default:0 items="Full,Summary,Page,None"|gettxtlist values="0,1,3,2" focus=1}
