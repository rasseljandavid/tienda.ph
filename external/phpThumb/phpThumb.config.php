...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../tmp/img_cache/';              // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['output_format']    = 'jpg'; // default output format ('jpeg', 'png' or 'gif') - thumbnail will be output in this format (if available in your version of GD or ImageMagick). This is only used if the "f" parameter is not specified, and if the thumbnail can't be output in the input format.
...
$PHPTHUMB_CONFIG['error_message_image_default'] = PATH_RELATIVE. 'framework/core/assets/images/default_preview_notfound.gif';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
