...
__cov_YEVObAz5rR5pcGkNfVHtzA.s['1']++;YUI.add('range-slider',function(Y,NAME){__cov_YEVObAz5rR5pcGkNfVHtzA.f['1']++;__cov_YEVObAz5rR5pcGkNfVHtzA.s['2']++;Y.Slider=Y.Base.build('slider',Y.SliderBase,[Y.SliderValueRange,Y.ClickableRail]);},'3.18.1',{'requires':['slider-base','slider-value-range','clickable-rail']});
